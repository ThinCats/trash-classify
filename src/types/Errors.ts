...
export class PropheticError {
  ...
  get isImageClassifyAPILimitedError() {
    return this.inCodes(PropheticErrorCode.ImageClassifyAPILimitedError)
  }
  get isImageClassifyAPIError() {
    return this.inCodes(PropheticErrorCode.ImageClassifyAPIError)
  }
  get isUploadImageTypeError() {
    return this.inCodes(PropheticErrorCode.UploadImageTypeError)
  }
  get isUploadImageSizeError() {
    return this.inCodes(PropheticErrorCode.UploadImageSizeError)
  }
  get isUploadImageURLError() {
    return this.inCodes(PropheticErrorCode.UploadImageURLError)
  }
  get isTrashNotFoundError() {
    return this.inCodes(PropheticErrorCode.TrashNotFoundError)
  }
}
...
export class PropheticErrorHandled {
  ...
  ImageClassifyAPILimitedError(handler: Handler) {
    return this.inCodes(
      PropheticErrorCode.ImageClassifyAPILimitedError,
      handler
    )
  }
  ImageClassifyAPIError(handler: Handler) {
    return this.inCodes(PropheticErrorCode.ImageClassifyAPIError, handler)
  }
  UploadImageTypeError(handler: Handler) {
    return this.inCodes(PropheticErrorCode.UploadImageTypeError, handler)
  }
  UploadImageSizeError(handler: Handler) {
    return this.inCodes(PropheticErrorCode.UploadImageSizeError, handler)
  }
  UploadImageURLError(handler: Handler) {
    return this.inCodes(PropheticErrorCode.UploadImageURLError, handler)
  }
  TrashNotFoundError(handler: Handler) {
    return this.inCodes(PropheticErrorCode.TrashNotFoundError, handler)
  }
  handle() {
    return this.handler()
  }
